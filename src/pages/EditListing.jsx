   ...
   navigate(`/category/${formDataCopy.type}/${docRef.id}`);
    ...
    return (
        <main className='max-w-md px-2 mx-auto'>
            ...
            focus:shadow-lg active:shadow-lg translation duration-150 ease w-full ${type === "rent" ? "bg-white text-black" : "bg-slate-600 text-white"
                            }`}>
                        sell
                    </button>
            ...
            focus:shadow-lg active:shadow-lg translation duration-150 ease w-full ${type === "sale" ? "bg-white text-black" : "bg-slate-600 text-white"
                            }`}>
                        rent
                    </button>
                </div>
         ...
         bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6'></input>
                ...
                <div className='flex'>
                    <button type='button' id='parking' value={true}
                        onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg 
            focus:shadow-lg active:shadow-lg translation duration-150 ease w-full ${!parking ? "bg-white text-black" : "bg-slate-600 text-white"
                            }`}>
                        Yes
                    </button>
            ...
            focus:shadow-lg active:shadow-lg translation duration-150 ease w-full ${parking ? "bg-white text-black" : "bg-slate-600 text-white"
                ...
                <div className='flex'>
                    <button type='button' id='furnished' value={true}
                        onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg 
            focus:shadow-lg active:shadow-lg translation duration-150 ease w-full ${!furnished ? "bg-white text-black" : "bg-slate-600 text-white"
                            }`}>
                        Yes
                    </button>
         ...
         bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6'></textarea>
                ...
                <div className='flex mb-6'>
                    <button type='button' id='offer' value={true}
                        onClick={onChange} className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg 
            focus:shadow-lg active:shadow-lg translation duration-150 ease w-full ${!offer ? "bg-white text-black" : "bg-slate-600 text-white"
                            }`}>
                        Yes
                    </button>
        ...
        transition duration-150 ease-in-out'>Edit Listing</button>
