    ...
    <section>
      ...
      items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className="md:w-[67%] lg:w-[50%] mb-12 md:mb-6">
          <img src="https://images.unsplash.com/photo-1605858286629-4268180c482b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=437&q=80" alt ="key"
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form >
            ...
            active:bg-blue-800'>Sign in</button>
